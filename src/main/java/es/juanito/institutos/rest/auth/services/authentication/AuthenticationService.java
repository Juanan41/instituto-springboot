...
import es.juanito.institutos.rest.auth.dto.JwtAuthResponse; // Importación adaptada
import es.juanito.institutos.rest.auth.dto.UserSignInRequest; // Importación adaptada
import es.juanito.institutos.rest.auth.dto.UserSignUpRequest; // Importación adaptada
