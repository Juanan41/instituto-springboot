package es.juanito.institutos.rest.users.mappers;

import es.juanito.institutos.rest.users.dto.UserInfoResponseDto; // DTOs corregidos
import es.juanito.institutos.rest.users.dto.UserRequestDto;      // DTOs corregidos
import es.juanito.institutos.rest.users.dto.UserResponseDto;     // DTOs corregidos
