package es.juanito.institutos.rest.users.repositories; // PAQUETE ADAPTADO: Repositorio de la entidad User

import es.juanito.institutos.rest.users.models.User; // Importación de tu entidad User
