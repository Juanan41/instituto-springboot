...
import es.juanito.institutos.auth.dto.JwtAuthResponse;
import es.juanito.institutos.auth.dto.UserSignInRequest;
import es.juanito.institutos.auth.dto.UserSignUpRequest;
import es.juanito.institutos.auth.exceptions.AuthDifferentPasswords;
import es.juanito.institutos.auth.exceptions.AuthExistingUsernameOrEmail;
import es.juanito.institutos.auth.exceptions.AuthSignInNotValid;
import es.juanito.institutos.auth.repositories.AuthUsersRepository;
import es.juanito.institutos.auth.services.jwt.JwtService;
import es.juanito.institutos.users.models.Role; // Adaptado
import es.juanito.institutos.users.models.User; // Adaptado
