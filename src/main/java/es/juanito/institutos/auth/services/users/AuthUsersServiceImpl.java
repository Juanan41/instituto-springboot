...
import es.juanito.institutos.auth.repositories.AuthUsersRepository; // Adaptado
import es.juanito.institutos.users.exceptions.UserNotFound; // Asumo esta ruta para la excepción
