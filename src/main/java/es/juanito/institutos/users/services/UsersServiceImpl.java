...
import es.juanito.institutos.users.exceptions.UserNotFound; // NUEVO NOMBRE
import es.juanito.institutos.users.exceptions.UserNameOrEmailExists; // NUEVO NOMBRE
import es.juanito.institutos.users.mappers.UsersMapper;
import es.juanito.institutos.users.models.User;
import es.juanito.institutos.users.repositories.UsersRepository; // Repositorio adaptado
